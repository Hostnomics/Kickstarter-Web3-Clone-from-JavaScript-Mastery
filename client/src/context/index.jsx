...
export const StateContextProvider = ({ children }) => {  //regular react functional component
        const { contract } = useContract('0x75D37883ae821720cC6fb09619Eb76CCBCA65Cf4') //Get contract address from our provider (ThirdWeb hosted dashboard) (1:56:01)
        ...
        return (
            ...
            <StateContext.Provider
                value={{ 
                    ...
                    // (2:00:53) - So, rename publishCampaign AS createCampaign like this: 
