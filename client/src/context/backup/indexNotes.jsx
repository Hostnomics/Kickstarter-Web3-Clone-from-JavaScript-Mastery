...
// from docs
        ...
        const publishCampaign = async (form) => {
            ...
            // don't use form.amountCollected,
                try {
...
// (2:12:39) - create getCampaigns function to be called from pages/Home.jsx 
        const getCampaigns = async () => {
            ...
            console.log(`log before parsing:`, campaigns)

            // (2:15:50) - parse through our campaigns and instantly return "()" an object "campaigns.map(() => ({}))"
...
// (~2:42:20) - get only campaigns belong to addy
